...
public class ExcelComparator {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (compareExcelFiles(file1, file2)) {
        System.out.println("The Excel files are identical + Comparison is passed ");
      } else {
  ...
  private static Workbook readExcelFile(String file1Path) {
	            ...
	            for (int k = 0; k < numberOfCells; k++) {
	                ...
	                if (cell1.getCellType() == CellType.STRING) {
	                    ...
	                    if (cell1.getBooleanCellValue() != cell2.getBooleanCellValue()) {
	                        System.out.println("Mismatched value in cell: [" + j + "," + k + "]");
	                        System.out.println("Expected value: " + cell1.getBooleanCellValue());
	                        System.out.println("Actual value: " + cell2.getBooleanCellValue());
	                        return false;
	                    }
	                }
	            }
